...
import { getCommunityFoodTitleList } from "../../apis/Community/CommunityTitleApis";

const CommunityBoardFoodTitle = () => {
    ...
    useEffect(() => {
        const CommunityTitleData = async () => {
            try {
                const res = await getCommunityFoodTitleList(currentPage);
                if (res) {
...
export default CommunityBoardFoodTitle
